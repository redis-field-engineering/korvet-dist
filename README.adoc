...
* link:samples/kafka-connect-file-sink/README.adoc[*Kafka Connect File Sink Sample*] - Local Kafka Connect smoke test writing Korvet events to a file
...
Korvet is licensed under the https://github.com/redis-field-engineering/korvet-dist/blob/main/LICENSE[Business Source License 1.1].
...
* **Change license**: Converts to MIT license four years after each version's publication

...
The samples use the official `redisfield/korvet` Docker image from Docker Hub. No build step required!
...
If you see `image korvet not found`, you need to build Korvet first. See "Building Korvet Locally" above.

...
NOTE: `make up` automatically builds the Korvet image if needed (takes 2-3 minutes first time). Wait 10-15 seconds for services to initialize.
...
make up         # Start services (builds image if needed)

...
korvet:
  environment:
    ...
    # JVM memory settings. Use JAVA_OPTS, not JAVA_TOOL_OPTIONS: the broker's baked
    # -XX:MaxDirectMemorySize default is applied after JAVA_TOOL_OPTIONS and would override it.
